...
class AIManager(BaseManager):
    ...
    def __init__(self):
        super().__init__()  # DB gerektirmeyen manager

    def call_openrouter(self, title: str, description: str) -> list[AITaskSuggestion]:
        ...
        try:
            ...
            raise AppException(detail="AI servisi yanıt vermedi. Lütfen tekrar deneyin.", status_code=503)
    ...
    def call_openrouter_for_report(self, title: str, content: str) -> dict:
    ...
    def _parse_response(self, raw: dict) -> list[AITaskSuggestion]:
        ...
        try:
            ...
            raise AppException(detail="AI yanıtı işlenirken hata oluştu. Lütfen tekrar deneyin.", status_code=500)

    def _parse_report_response(self, raw: dict) -> dict:
