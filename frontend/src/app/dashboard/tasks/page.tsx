...
import { CheckSquare, Search, X, Sparkles } from "lucide-react";
...
> = {
  TODO:        { label: "Yapılacak",    className: "border-slate-600/60 bg-slate-800/60 text-slate-300",       dot: "bg-slate-400" },
  IN_PROGRESS: { label: "Devam Ediyor", className: "border-blue-500/30 bg-blue-500/10 text-blue-400",          dot: "bg-blue-400" },
  REVIEW:      { label: "İncelemede",   className: "border-amber-500/30 bg-amber-500/10 text-amber-400",       dot: "bg-amber-400" },
  DONE:        { label: "Tamamlandı",   className: "border-emerald-500/30 bg-emerald-500/10 text-emerald-400", dot: "bg-emerald-400" },
};
