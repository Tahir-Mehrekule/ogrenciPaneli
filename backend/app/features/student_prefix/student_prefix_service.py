...
class StudentPrefixService(BaseService[StudentPrefix, StudentPrefixRepo]):
    ...
    def update(self, prefix_id: UUID, data: PrefixUpdate) -> PrefixResponse:
    ...
    def delete(self, prefix_id: UUID) -> dict:
        prefix = self.repo.get_by_id_or_404(prefix_id)
